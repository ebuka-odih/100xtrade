                                ...
                                <div class="card card-bordered card-full">
                                    ...
                                    <div class="card-inner">
                                        <button type="button" class="btn btn-primary m-4" data-bs-toggle="modal"
                                                data-bs-target="#modalForm">Add Trader
                                        </button>
...
{{--                                                        <td>${{ number_format($item->max_amount, 2) ?? '' }}</td>--}}
                                                        <td>{{ $item->win_rate ?? ''}}%</td>
                                                        <td>${{ number_format($item->profit_share, 2) ?? ''}}</td>
                                                        <td>{{ $item->win ?? ''}}</td>
                                                        <td>{{ $item->loss ?? ''}}</td>
                                                        <td>
    ...
    <div class="modal fade" id="modalForm">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.copyTrader.store') }}" method="POST" class="form-validate is-alter"
                          enctype="multipart/form-data">
                        @csrf
                        <div class="row mt-2">
                            <div class="col-lg-6">
                        ...
                        <div class="row mt-2">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-label" for="full-name">Win</label>
                                    <div class="form-control-wrap">
                                        <input type="number" step="0.001" name="win" class="form-control" id="full-name"
                                               required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="number" step="0.001" name="loss" class="form-control"
                        ...
                        <div class="row mt-2">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="number" step="0.001" name="win_rate" class="form-control"
