        ...
        <nav class="sidebar mb-4">
            <ul class="nav flex-column" id="nav_accordion">
              ...
              <span class="fa fa-arrow-up">
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex gap-2 align-items-center {{ Route::is('user.stocks') || Route::is('user.stockHoldings') || Route::is('user.filledOrders') || Route::is('user.sellHistory') ? 'active' : '' }}"
                       href="#" data-bs-toggle="collapse" data-bs-target="#stockSubmenu" aria-expanded="false">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" class="ms-auto">
                            <path fill="currentColor" d="M7 10l5 5l5-5z"/>
                        </svg>
                    </a>
                    <ul class="nav flex-column ms-3 collapse" id="stockSubmenu">
                        <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex gap-2 align-items-center {{ Route::is('user.subscription.index') ? 'active' : '' }}"
        ...
        <nav class="navbar navbar-expand-lg py-lg-3 px-2 px-lg-4 d-flex fixed-top justify-content-between">
            ...
            <div class="d-flex gap-3 p-lg-2 p-lg-0 align-items-center justify-content-end">
                <div style="margin-right: 10px">
                    <strong class="badge bg-dark" style="color: green; font-size: 16px"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24"><path fill="currentColor" d="M11.25 7.847c-.936.256-1.5.975-1.5 1.653s.564 1.397 1.5 1.652zm1.5 5.001v3.304c.936-.255 1.5-.974 1.5-1.652s-.564-1.397-1.5-1.652"/><path fill="currentColor" fill-rule="evenodd" d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10M12 5.25a.75.75 0 0 1 .75.75v.317c1.63.292 3 1.517 3 3.183a.75.75 0 0 1-1.5 0c0-.678-.564-1.397-1.5-1.653v3.47c1.63.292 3 1.517 3 3.183s-1.37 2.891-3 3.183V18a.75.75 0 0 1-1.5 0v-.317c-1.63-.292-3-1.517-3-3.183a.75.75 0 0 1 1.5 0c0 .678.564 1.397 1.5 1.652v-3.469c-1.63-.292-3-1.517-3-3.183s1.37-2.891 3-3.183V6a.75.75 0 0 1 .75-.75" clip-rule="evenodd"/></svg>
                    {{ number_format(auth()->user()->balance, 2) }}</strong>
                </div>
